...
namespace __PLUGIN_NAMESPACE__\Models\Sluggable;

use WPWCore\Database\Eloquent\Model;
use WPWhales\Support\Str;
use __PLUGIN_NAMESPACE__\Exceptions\InvalidOption;
...
trait HasSlug
{
    ...
    protected function getSlugSourceString(): string
    {
        ...
        $slugSourceString = \WPWCore\Collections\collect($this->slugOptions->generateSlugFrom)
            ->map(fn (string $fieldName): string => \WPWCore\Collections\data_get($this, $fieldName, ''))
    ...
    {
        return in_array('WPWCore\Database\Eloquent\SoftDeletes', class_uses($this), true);
    }
